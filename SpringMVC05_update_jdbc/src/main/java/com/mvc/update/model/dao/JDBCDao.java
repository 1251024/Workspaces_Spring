...
public interface JDBCDao {
	...
	String SELECT_ONE_SQL = " SELECT SEQ, WRITER, TITLE, CONTENT, REGDATE "
							+ " FROM JDBCBOARD "
							+ " WHERE SEQ =? ";
	String INSERT_SQL = " INSERT INTO JDBCBOARD VALUES(JDBCSEQ.NEXTVAL, ?, ?, ?, SYSDATE) ";
	String UPDATE_SQL = " UPDATE FROM JDBCBOARD SET TITLE =?, CONTENT=? ";
	String DELETE_SQL = " DELETE FROM JDBCBOARD WHERE SEQ=? ";
